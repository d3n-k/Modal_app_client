...
import { TABLE_ROUTE, TABLE_ROUTE_1, TABLE_ROUTE_2, TABLE_ROUTE_3, TABLE_ROUTE_4, TABLE_ROUTE_5, TABLE_ROUTE_6, TABLE_ROUTE_7 } from "../utils/consts";
    ...
    <div className="App">
      ...
      <Container>
        <div style={{ marginTop: "2rem" }} className="cards">
          <Row>
            <Col style={{ display: 'flex' }} onClick={() => navigate(TABLE_ROUTE_6)}>
              <CardComp
                title="Модель оценки выраженности воспалительного процесса у недоношенных новорожденных с врожденной пневмонией на протяжении неонатального периода по данным общего анализа крови"
                name="Рубникович С.П., Горячко А.Н."
                description="Разработанная по данным общего анализа крови и на основании бинарной логистической регрессии математическая модель позволяет на протяжении первого месяца жизни проводить оценку выраженности патологического процесса при врожденной пневмонии у недоношенных новорожденных."
              />
            </Col>
            <Col style={
              mobile
            ...
            } onClick={() => navigate(TABLE_ROUTE_7)}>
              <CardComp
                title="Математическая модель оценки выраженности воспалительного процесса у недоношенных новорожденных с врожденной пневмонией на протяжении первого месяца жизни по данным кислотно-основного состояния и биохимического анализа крови"
                name="Рубникович С.П., Горячко А.Н."
                description="Разработанная на основании бинарной логистической регрессии математическая модель позволяет в неонатальном периоде по результатам кислотно-основного состояния и биохимического анализа крови проводить оценку выраженности воспалительного процесса при врожденной пневмонии у недоношенных младенцев."
              />
            </Col>
          </Row>
          ...
          <Row style={{ marginTop: '1.5rem' }}>
            ...
            <Col style={
              ...
              <CardComp
                ...
                name="Горячко А.Н., Сукало А.В., Улезко Е.А."
                description="Прогностическая модель методом многомерного анализа позволяет в течение первых суток жизни, на основании показателей свертывания крови, выделить недоношенных новорожденных с врожденной пневмонией в группу риска по развитию геморрагического синдрома."
              />
            </Col>
          </Row>
        </div>
