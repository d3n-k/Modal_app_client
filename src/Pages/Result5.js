    ...
    <Container>
        <div className="divCol">
          <Row style={{marginTop: '0.75rem'}}>
            <Col className="colR" >Дыхательная недоста­точность III степени</Col>
            <Col className="colR" md={1}>Асфиксия</Col>
            <Col className="colR" >Гемодинами­ческие нарушения крово­обращения с гипотензией</Col>
            <Col className="colR" >{'Лейкопения или лейкоцитоз (<5х10*9/л или >30х10*9/л)'}</Col>
            <Col className="colR">Изменение объема около­плодных вод</Col>
            <Col className="colR">{'Тромбоци­топения (<150х10*9/л)'}</Col>
            <Col className="colR">{'Высокий уровень С-реактивного белка(> 6 мг/л)'}</Col>
            <Col className="colR">Изменения плаценты воспали­тельного характера</Col>
          ...
          <Row>
            ...
            <Col  className="colR2" md={1} >{col5.cols5.c2 || localData.c2}</Col>
