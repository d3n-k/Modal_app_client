...
const Result5 = observer(() => {
  ...
  function createPdf() {
    axios
      .post(process.env.REACT_APP_HOST + "/create-pdf5", data)
      .then(() =>
        axios.get(process.env.REACT_APP_HOST + "/table5", { responseType: "blob" })
      )
      .then((res) => {
      ...
      <div className="divCol">
        {mobile ? (
          <>
            ...
            <Row>
              <Col className="colR">
                {"С-реактивный белок (> 6 мг/л или выше нормативного значения)"}
              </Col>
